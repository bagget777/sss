...
# po = ["citi","hour","friend","Bishkek","park","car","girl","game","music","java","python","apple","shop","system","site"]
# print(po)
# print(po)
# 2) Создайте вручную список из чисел и выведите их в обратном порядке
# numbers = [10, 11, 100, 1, 3, 4, 400, 1001, 0, 5]
# numbers2 = numbers[::-1]
# print(numbers2)
